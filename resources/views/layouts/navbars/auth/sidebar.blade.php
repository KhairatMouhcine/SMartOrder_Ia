          ...
          <a class="nav-link {{ (Request::is('produits*') ? 'active' : '') }}" href="{{ url('produits') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <svg width="12px" height="12px" viewBox="0 0 45 40" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M10 0h25a5 5 0 0 1 5 5v30a5 5 0 0 1-5 5H10a5 5 0 0 1-5-5V5a5 5 0 0 1 5-5z" fill="#FFFFFF" class="color-background opacity-6"/>
                      <path d="M12 12h21v2H12zM12 18h21v2H12zM12 24h21v2H12z" fill="#FFFFFF" class="color-background"/>
                  </svg>
              </div>
          ...
          <a class="nav-link {{ (Request::is('commandes*') ? 'active' : '') }}" href="{{ url('commandes') }}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  <svg width="12px" height="12px" viewBox="0 0 45 40" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path d="M5 10h35v25a5 5 0 0 1-5 5H10a5 5 0 0 1-5-5V10z" fill="#FFFFFF" class="color-background opacity-6"/>
                      <path d="M15 5h15v5H15z" fill="#FFFFFF" class="color-background"/>
                  </svg>
              </div>
